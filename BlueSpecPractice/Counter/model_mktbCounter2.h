...
/* Generation options: */
#ifndef __model_mktbCounter2_h__
#define __model_mktbCounter2_h__
...
/* Class declaration for a model of mktbCounter2 */
class MODEL_mktbCounter2 : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mktbCounter2 *mktbCounter2_instance;
...
#endif /* ifndef __model_mktbCounter2_h__ */
